...
3. 提取可用于排序训练的英文句子，wordBlocks 必须是句子拆分后的词块。
4. 提取语法点，并生成语法选择题。
5. 如有阅读文章，生成阅读选择题。
6. generatedExercises 汇总生成适合闯关的题目，stage 可用：vocab, phrase, sentence, grammar, reading, exam。
7. 如果资料很少，也要基于资料生成合理的最小任务，但不要编造与资料无关的内容。
